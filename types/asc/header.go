...
func (h Header) MarshalJSON() ([]byte, error) {
	...
	enc.Bloom = h.Bloom
	enc.Difficulty = (*hexutil.Big)(big.NewInt(h.Difficulty))
	enc.Number = (*hexutil.Big)(big.NewInt(h.Number))
...
func (h *Header) ExtractSignerFromHeader() (signer common.Address, err error) {
